...
class SquarePyramid(RigidObjectOmni):
    def __init__(self, 
                 ...
                 inertia=None,
                 com=None,
                 object_name="SquarePyramid") -> None:
        
        object_usd_path =  os.path.join(root_ws_dir, "design", "ObjectUSD", "square_pyramid", "square_pyramid.usd")
        ...
        object_prim_name = "/SquarePyramid"
