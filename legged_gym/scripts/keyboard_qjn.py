...
class env:
    ...
    def keyboard_test_env(self):
        ...
        BennettWheelRoughCfg.env.num_envs = self.num_envs
        BennettWheelRoughCfg.env.episode_length_s = self.reset_time
        BennettWheelRoughCfg.commands.resampling_time = self.reset_time
        BennettWheelRoughCfg.commands.heading_command = False

        # MUTS BE 10N
        BennettWheelRoughCfg.terrain.num_rows = 10
        # terrain types: [smooth slope, rough slope, stairs up, stairs down, discrete]
        BennettWheelRoughCfg.terrain.num_cols = 1
        # BennettWheelRoughCfg.terrain.curriculum = False

        # # mesh_type = 'trimesh' # "heightfield" # none, plane, heightfield or trimesh
        # BennettWheelRoughCfg.terrain.mesh_type = "trimesh"
        BennettWheelRoughCfg.terrain.mesh_type = "plane"
        # BennettWheelRoughCfg.terrain.terrain_proportions = [0.0001, 0.0001, 0.0001, 0.0001, 0.9996 ]
        # BennettWheelRoughCfg.terrain.vertical_scale = 0.00025

        # BennettWheelRoughCfg.terrain.selected = True
        # BennettWheelRoughCfg.terrain.terrain_kwargs = {
        #     'type': 'rough_slope',
        #     'slope': 0.2,
        #     'step_height': 0.1
        # }
        
        # BennettWheelRoughCfg.terrain.horizontal_scale = 0.01

        # BennettWheelRoughCfg.terrain.border_size = 25
        ...
        train_cfg_dict = class_to_dict(BennettWheelRoughCfgPPO)
        ...
        # model_path = os.path.join(cur_path, '../../logs/rough_bennett/Jan28_16-44-23_/model_4950.pt')
        # model_path = os.path.join(cur_path, '../../logs/rough_bennett/Jan31_21-24-31_/model_9900.pt')
        # model_path = os.path.join(cur_path, '../../logs/rough_a1/Jan29_10-33-47_/model_1500.pt')
        # model_path = os.path.join(cur_path, '../../logs/rough_bennett/Jan28_11-27-19_/model_4000.pt')
        model_path = os.path.join(cur_path,  '../../logs/rough_bennett_wheel/Jan29_15-49-38_/model_1600.pt')
